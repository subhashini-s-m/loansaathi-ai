      ...
      <main className="container py-8 md:py-12">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-bold text-foreground md:text-3xl">AI Loan Eligibility Analyzer</h1>
          </div>
          <p className="text-muted-foreground">Enter your details to get an AI-powered assessment with explainable decisions</p>
          {sampleCase && (
            <Badge variant="outline" className="mt-2 bg-saffron/10 text-saffron border-saffron/20">
              📋 Sample Case: {sampleCase.title} — {sampleCase.description}
            </Badge>
          )}
        </motion.div>
        ...
        <div className="grid gap-8 lg:grid-cols-5">
          <div className="lg:col-span-3">
            <div className="rounded-xl border border-border bg-card p-6 shadow-card">
              <h2 className="mb-4 text-lg font-semibold text-foreground">Your Financial Details</h2>
            ...
            {result ? (
              ...
              <div className="flex h-full items-center justify-center rounded-xl border border-dashed border-border bg-card/50 p-10 text-center">
                <div>
                  ...
                  <p className="text-muted-foreground">Fill the form and click "Analyze" to see your AI assessment</p>
                </div>
              </div>
            )}
          </div>
