...
const BankRecommendations = ({ banks }: BankRecommendationsProps) => (
  ...
  >
    <div className="mb-5 flex items-center gap-2">
      ...
      <div>
        <h3 className="text-lg font-semibold text-foreground">Recommended Banks</h3>
    ...
    <div className="mt-4 flex items-start gap-2 rounded-lg bg-secondary/50 p-3 text-xs text-muted-foreground">
      ...
      <span>Demo data for prototype — designed for real-world integration with bank APIs.</span>
    </div>
  </motion.div>
);
