...
const RoadmapSection = ({ steps }: RoadmapSectionProps) => (
  ...
  >
    <div className="mb-5 flex items-center gap-2">
      ...
      <div>
        <h3 className="text-lg font-semibold text-foreground">Your AI Financial Companion</h3>
        <p className="text-xs text-muted-foreground">Personalized Loan Readiness Roadmap</p>
      </div>
    </div>
